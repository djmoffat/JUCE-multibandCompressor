...
public:
    ...
    */
    ...
    /** Returns the coefficients for a Linkwitz Riley second order low-pass filter. */
    static IIRCoefficients makeLRLowPass (double sampleRate,
                                        double frequency) noexcept;
    
    /** Returns the coefficients for a Linkwitz Riley second order high-pass filter. */
    static IIRCoefficients makeLRHighPass (double sampleRate,
                                         double frequency) noexcept;
